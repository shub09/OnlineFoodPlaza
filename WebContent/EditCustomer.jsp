...
<%  Customer cust=(Customer)session.getAttribute("cust"); %>
  ...
  <table bgcolor="gray" border="1" bordercolor="green" align="center" cellpadding="15" >
        <tr>
            <td>Customer Id</td>
            <td>
                  <input type="text" name="customerid" value=<%=cust.getCustomerId()%> readonly>
                  <br>             
         ...
         <tr>
            <td>Customer Name</td>
            <td>
                  <textarea rows="1" cols="20" name="customername" id="cname"><%=cust.getCustomerName()%>
                  </textarea>
                  <br>
         ...
         <tr>
            ...
            <td>
                 <textarea rows="5" cols="20" name="customeraddress" id="caddress"><%=cust.getCustomerAddress()%>
                 </textarea>
                 <br>
         ...
         <tr>
            ...
            <td>
                  <input type="text" name="contact" id="ccontact" value=<%=cust.getContact()%>>
                  <br>
          ...
          <tr>
            <td>Set UserName</td>
            <td>
                  <input type="text" name="uname" value=<%=cust.getCustomerUserName()%>>
                 <br>
                  <span id="ccontactError" style="color:red"></span>
            </td>
        </tr> 
        <tr>
            <td>Set Password</td>
            <td>
                  <input type="password" name="password" value=<%=cust.getCustomerPassword()%>>
                  <br>
                  <span id="ccontactError" style="color:red"></span>
            </td>
        </tr> 
